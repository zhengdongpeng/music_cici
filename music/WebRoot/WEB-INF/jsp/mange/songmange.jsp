	...
	<%if(mange.getJibie()==2) {%>
       <div>
       		...
       		<hr>
       		  ...
       		  <form name="Form2" action="fileUploadSong.do" method="post"  enctype="multipart/form-data">
       		  			<input type="hidden" name="type" value="1"/>
                      歌曲文件：<input name="file" type="file"  accept="audio/mpeg"  value="浏览"/><br>
                      歌曲名：<input type="text"  name="songname1" class="songname1"/><br>
                       ...
                       所属专辑：
                           ...
                           <% 
                           List<Album> album =(List<Album>) request.getAttribute("zjid");
                           for(int i=0;i<album.size();i++){ %>
  						<option value ="<%=album.get(i).getAlbumId()%>"><%=album.get(i).getAname() %></option>
  					<%} %>
 	 					</select>
                      ...
                      歌曲类型：
                          <select  class="songtype" name="songtype">
                    ...
                    歌曲图片：    <input name="file2" type="file"  accept="image/jpeg,image/png"  value="浏览">
                      <div>
    <h1>歌词</h1>
			<textarea rows="4" cols="80"  class="geci" name="geci"></textarea>
                      </div>
...
function deleteMange(){
	...
	$.ajax({
		  url:"mangedelete.do",
		    ...
		    data:{username:username,type:'song'},
