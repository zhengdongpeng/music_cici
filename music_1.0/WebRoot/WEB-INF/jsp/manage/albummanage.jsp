...
<body background="images/manage/bgt5.gif" class="htbg">
	<div id="wrapper1">
		<div>
		  ...
		  url:"managequery.do",
		    ...
		    success:function(data){
		    	...
		    	for(var i=0;i<list.length;i++){
		    		...
		    		+"<td width='200px'><a onclick=\"modifySinger('"+i+"')\">修改</a>|<a onclick=\"deletemanage('"+list[i].albumId+"')\">删除</a</td></tr>";
		    		$(".query").append(str);
		    	}
		    },
...
function modifySinger(i){
	...
	function getSinger(type) {
		...
		if(type=='create'){
			...
			singerType=	$(".singerTypeUpdate").val();
			clazz=".singerupdate";
		}
		if (!singerType)
			return;
