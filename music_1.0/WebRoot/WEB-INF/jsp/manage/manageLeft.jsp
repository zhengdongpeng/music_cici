...
<div >
<ul  >
  <li> <a href="managepager.do">管理员管理</a></li>
<li> <a href="usermanage.do">用户管理</a></li>
<li> <a href="songmanage.do">歌曲管理</a></li>
<li> <a href="albummanage.do">专辑管理</a></li>
<li> <a href="singermanage.do">歌手管理</a></li>
