...
(function($){
	...
	Page.prototype.setStyle=function(){
		...
		this.obj.find('a.turndown').css({'margin-left':'5px','display':'inline-block','width':'50px','height':s.height-2+'px','line-height':s.height-2+'px'});
		...
		this.obj.find('span.countYe').css({'color':'#4C4C4C','font-size':s.fontSize+'px','width':'400px'});
